...
namespace Lax.Data.EntityFrameworkCore.Configuration.Infrastructure {
    ...
    public class EntityTypeConfigurationOptionsExtension
        ...
        public void ApplyServices(IServiceCollection services) {
            ...
            ServiceDescriptor modelCustomizerServiceDescriptor =
                ServiceDescriptor.Singleton<IModelCustomizer, EntityTypeConfigurationModelCustomizer>();
