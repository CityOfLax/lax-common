...
namespace Lax.Data.SharePoint.Lists.Utils {
    ...
    public static class Guard {
        ...
        public static void CheckNotNullOrEmpty([InvokerParameterName] [CanBeNull] string paramName,
        ...
        public static void CheckNotNullOrEmpty<T>([InvokerParameterName] [CanBeNull] string paramName,
        ...
        public static void CheckIsTypeAssignableTo([InvokerParameterName] [CanBeNull] string paramName,
            [NotNull] Type actualType, [NotNull] Type expectedType) {
        ...
        public static void CheckIsTypeAssignableTo<TExpected>([InvokerParameterName] [CanBeNull] string paramName,
        ...
        public static void CheckIsObjectAssignableTo([InvokerParameterName] [CanBeNull] string paramName,
            [CanBeNull] object actualValue, [NotNull] Type expectedType) {
            CheckNotNull(nameof(expectedType), expectedType);
            ...
            if (actualValue == null) {
                ...
                throw new ArgumentException(
                    $"Parameter '{paramName}' is null, but expected type '{expectedType}' is not a System.Nullable`1 and is not a class type.",
                    paramName);
            }
        ...
        public static void CheckIsObjectAssignableTo<TExpected>([InvokerParameterName] [CanBeNull] string paramName,
