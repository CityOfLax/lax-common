...
namespace Lax.Data.SharePoint.Lists.Extensions {
    ...
    public static class EnumerableExtensions {
        ...
        [NotNull]
        public static string JoinToString<T>([CanBeNull, InstantHandle] this IEnumerable<T> enumerable,
            [CanBeNull] string delimeter = "; ") => 
                enumerable == null ? "" : string.Join(delimeter ?? "", enumerable);
        ...
        public static void Each<T>([CanBeNull, InstantHandle] this IEnumerable<T> enumerable,
