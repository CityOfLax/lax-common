...
namespace Lax.Data.SharePoint.Lists.Data {
    ...
    internal static class MethodUtils {
        ...
        public static readonly MethodInfo QSelect =
            GetMethodInfo(() => Queryable.Select(null, default(Expression<Func<int, int>>)));

        public static readonly MethodInfo QMin = GetMethodInfo(() => Queryable.Min<int>(null));

        public static readonly MethodInfo QMinP =
            GetMethodInfo(() => Queryable.Min(null, default(Expression<Func<int, int>>)));

        public static readonly MethodInfo QMax = GetMethodInfo(() => Queryable.Max<int>(null));

        public static readonly MethodInfo QMaxP =
            GetMethodInfo(() => Queryable.Max(null, default(Expression<Func<int, int>>)));

        public static readonly MethodInfo QWhere =
            GetMethodInfo(() => Queryable.Where(null, default(Expression<Func<int, bool>>)));
        ...
        public static readonly MethodInfo QOrderByDescending =
            GetMethodInfo(() => Queryable.OrderByDescending<int, int>(null, null));

        public static readonly MethodInfo QThenBy = GetMethodInfo(() => Queryable.ThenBy<int, int>(null, null));

        public static readonly MethodInfo QThenrByDescending =
            GetMethodInfo(() => Queryable.ThenByDescending<int, int>(null, null));
        ...
        public static readonly MethodInfo QSingleOrDefaultP =
            GetMethodInfo(() => Queryable.SingleOrDefault<int>(null, null));

        public static readonly MethodInfo QFirstOrDefault = GetMethodInfo(() => Queryable.FirstOrDefault<int>(null));

        public static readonly MethodInfo QFirstOrDefaultP =
            GetMethodInfo(() => Queryable.FirstOrDefault<int>(null, null));

        public static readonly MethodInfo QLastOrDefault = GetMethodInfo(() => Queryable.LastOrDefault<int>(null));

        public static readonly MethodInfo QLastOrDefaultP =
            GetMethodInfo(() => Queryable.LastOrDefault<int>(null, null));
        ...
        public static readonly MethodInfo QElementAtOrDefault =
            GetMethodInfo(() => Queryable.ElementAtOrDefault<int>(null, 0));
        ...
        public static readonly MethodInfo SpqSelect =
            GetMethodInfo(() => SpQueryable.Select<int, int>(null, null, null));
        ...
        public static readonly MethodInfo SpqFirst =
            GetMethodInfo(() => SpQueryable.First<int>(null, null, false, false));

        public static readonly MethodInfo SpqFirstP =
            GetMethodInfo(() => SpQueryable.First<int, int>(null, null, false, false, null));

        public static readonly MethodInfo SpqElementAt =
            GetMethodInfo(() => SpQueryable.ElementAt<int>(null, null, 0, false));

        public static readonly MethodInfo SpqElementAtP =
            GetMethodInfo(() => SpQueryable.ElementAt<int, int>(null, null, 0, false, null));
