...
namespace Lax.Data.SharePoint.Lists.Data.Translators {
    ...
    internal class CamlQueryTranslator : IProcessor<QueryModel, string> {
        ...
        private XElement Where([NotNull] ComparisonModel comparison) {
            ...
            return WhereComparison(comparison.ComparisonOperator, comparison.Field, comparison.Value,
        ...
        [NotNull]
        private XElement WhereComparison(ComparisonOperator comparisonOperator, [NotNull] MetaField metaField,
            object value,
            bool alreadyConverted = false) {
