...
namespace Lax.Data.SharePoint.Lists.Data.Translators.Predicate {
    ...
    internal class CamlPredicateProcessor : IProcessor<Expression, WhereModel> {
        ...
        private static readonly IReadOnlyDictionary<ExpressionType, ComparisonOperator> ComparisonMap =
            new Dictionary<ExpressionType, ComparisonOperator> {
        ...
        private static readonly IReadOnlyDictionary<ExpressionType, ComparisonOperator> NullComparisonMap =
            new Dictionary<ExpressionType, ComparisonOperator> {
