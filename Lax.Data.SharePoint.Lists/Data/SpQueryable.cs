...
namespace Lax.Data.SharePoint.Lists.Data {
    ...
    internal static class SpQueryable {
        ...
        internal static MethodCallExpression MakeFetch(Type entityType, ISpListItemsProvider listItemsProvider,
        ...
        internal static MethodCallExpression MakeTake(Type entityType, Type resulType,
            ISpListItemsProvider listItemsProvider,
        ...
        internal static MethodCallExpression MakeMin(Type contentType, Type resulType,
            ISpListItemsProvider listItemsProvider,
            QueryModel queryModel, LambdaExpression selector) {
        ...
        internal static MethodCallExpression MakeMax(Type contentType, Type resulType,
            ISpListItemsProvider listItemsProvider,
            QueryModel queryModel, LambdaExpression selector) {
        ...
        internal static MethodCallExpression MakeMax(Type contentType, ISpListItemsProvider listItemsProvider,
            QueryModel queryModel) {
